...
module CampusCoin::fa_coin {
    ...
    const ASSET_NAME: vector<u8> = b"Campus Coin";
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@CampusCoin, ASSET_SYMBOL);
    ...
    #[test(creator = @CampusCoin, aaron = @0xface)]
